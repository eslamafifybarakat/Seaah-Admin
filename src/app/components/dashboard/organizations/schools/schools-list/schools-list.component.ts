...
export class SchoolsListComponent {
  ...
  private loadData(): void {
    this.tableHeaders = [
      ...
      { field: 'educational_level', header: 'labels.educationalLevel', title: this.publicService?.translateTextFromJson('labels.educationalLevel'), type: 'text', sort: false, showDefaultSort: true, showAscSort: false, showDesSort: false, filter: false },
